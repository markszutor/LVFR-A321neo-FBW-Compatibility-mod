...
class LandingElevationIndicator extends DisplayComponent {
    ...
    handleLandingElevation() {
        ...
        this.delta = delta;
        if (delta > DisplayRange$3 || (this.flightPhase !== 7 && this.flightPhase !== 8)) {
    ...
    render() {
        return (FSComponent.buildComponent("g", { id: "AltitudeTape" },
            ...
            FSComponent.buildComponent("g", { ref: this.tapeRef },
                FSComponent.buildComponent(VerticalTape, { displayRange: DisplayRange$3 + 30, valueSpacing: ValueSpacing$5, distanceSpacing: DistanceSpacing$5, lowerLimit: -1500, upperLimit: 50000, tapeValue: this.subscribable, type: "altitude" }))));
    }
}
    ...
    render() {
        return (FSComponent.buildComponent(FSComponent.Fragment, null,
            ...
            FSComponent.buildComponent("g", { ref: this.tcasFailed, style: "display: none" },
                FSComponent.buildComponent("text", { class: "Blink9Seconds FontLargest Amber EndAlign", x: "141.5", y: "96" }, "T"),
                FSComponent.buildComponent("text", { class: "Blink9Seconds FontLargest Amber EndAlign", x: "141.5", y: "104" }, "C"),
                FSComponent.buildComponent("text", { class: "Blink9Seconds FontLargest Amber EndAlign", x: "141.5", y: "112" }, "A"),
                FSComponent.buildComponent("text", { class: "Blink9Seconds FontLargest Amber EndAlign", x: "141.5", y: "120" }, "S")),
        ...
        return (FSComponent.buildComponent("g", { ref: this.birdPath },
            FSComponent.buildComponent("svg", { x: "53.4", y: "65.3", width: "31px", height: "31px", version: "1.1", viewBox: "0 0 31 31", xmlns: "http://www.w3.org/2000/svg" },
                FSComponent.buildComponent("g", { ref: this.birdPathWings, class: "CornerRound" },
                    FSComponent.buildComponent("path", {
                        class: "NormalOutline",
...
class VAlphaProtBar extends DisplayComponent {
    ...
    render() {
        return (FSComponent.buildComponent("path", {
            id: "VAlphaProtBarberpole", ref: this.VAprotIndicator, class: "BarAmber",
            // eslint-disable-next-line max-len
...
class VMaxBar extends DisplayComponent {
    ...
    render() {
        return (FSComponent.buildComponent("path", {
            id: "OverspeedBarberpole", ref: this.VMaxIndicator, class: "BarRed",
            // eslint-disable-next-line max-len
...
class VStallWarnBar extends DisplayComponent {
    ...
    render() {
        return (FSComponent.buildComponent("path", {
            id: "StallWarnBarberpole", ref: this.VStallWarnIndicator, class: "BarRed",
            // eslint-disable-next-line max-len
...
(function (PFDVars) {
    ...
    PFDVars["landingElevation"] = "L:A32NX_PRESS_AUTO_LANDING_ELEVATION";
    ...
    PFDVars["flexTemp"] = "L:AIRLINER_TO_FLEX_TEMP";
